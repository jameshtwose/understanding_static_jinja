...
from index_html_helpers import start_doc, end_doc, start_doc_index, navbar_start, navbar_end, dropdown_example, dropdown_begin
...
with open(file_name, "w") as f:
    with redirect_stdout(f):
        ...
        start_doc_index(title_string = title_string)       
